...
> Minecraft 1.21.11 Fabric VRAM optimization mod — diagnose and reduce GPU VRAM usage.
...
**SW:** MC 1.21.11 + Sodium 0.6.0-beta + Iris 1.8.6 + ComplementaryShaders + 80+ mods
